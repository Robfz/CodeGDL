...
function crearPalabraQueAdivinar() {
    ...
    let stringLetrasAdivinadas = generarStringConLetrasAdivinadas();
...
function generarStringConLetrasAdivinadas() {
    // Crea un string con el contenido del arreglo "letrasAdivinas"
...
function actualizarLetrasAdvinas(letra, indices) {
    ...
    for (let i = 0; i < indices.length; i += 1) {
        letrasAdivinadas[indices[i]] = letra;
    }
